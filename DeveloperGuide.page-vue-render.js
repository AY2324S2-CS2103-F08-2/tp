...
with(this){return _c('ul',[_c('li',[_v("The list is initialised to have an empty string as the initial element")]),_v(" "),_c('li',[_v("The current command index defaults to 0")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("getCurrentCommand()\n"),_c('ol',[_c('li',[_v("Gets the command at the current command index")])])]),_v(" "),_c('li',[_v("undo()\n"),_c('ol',[_c('li',[_v("Decrements the current command index by 1")]),_v(" "),_c('li',[_v("If the current command index is already 0, it will play a Boop sound to indicate that there is\nare no more commands left to undo")])])]),_v(" "),_c('li',[_v("redo()\n"),_c('ol',[_c('li',[_v("Increments the current command index by 1")])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("Staff at SoC Center for Future Graduates (CFG)")]),_v(" "),_c('li',[_v("has a need to manage a significant number of contacts due to the large number of students requiring counselling services")]),_v(" "),_c('li',[_v("prefer desktop apps over other types")]),_v(" "),_c('li',[_v("can type fast")]),_v(" "),_c('li',[_v("prefers typing to mouse interactions")]),_v(" "),_c('li',[_v("is reasonably comfortable using CLI apps")]),_v(" "),_c('li',[_v("only a single user")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(": Manage students that are being counselled by him faster than a typical mouse/GUI application.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Use case: View one case log of an appointment of a specific student")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User searches for specific student.")])]),_v(" "),_c('li',[_c('p',[_v("CogniCare shows a list of students that meet the criteria.")])]),_v(" "),_c('li',[_c('p',[_v("User requests to list all appointments at the given the student index.")])]),_v(" "),_c('li',[_c('p',[_v("CogniCare shows a list of appointments that meet the criteria.")])]),_v(" "),_c('li',[_c('p',[_v("User requests to find the case log of the appointment at the given student and appointment.")])]),_v(" "),_c('li',[_c('p',[_v("CogniCare shows the case log that meets the criteria.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The query has missing parameters")]),_v(" "),_c('ul',[_c('li',[_v("1a1. CogniCare shows an error message.")])]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("2a. The list of students is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The query has missing parameters")]),_v(" "),_c('ul',[_c('li',[_v("3a1. CogniCare shows an error message.")])]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("4a. The list of appointments is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("5a. The query has missing/out of bound parameters")]),_v(" "),_c('ul',[_c('li',[_v("5a1. CogniCare shows an error message.")])]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("6a. There is no case log for such appointment")]),_v(" "),_c('ul',[_c('li',[_v("6a1. CogniCare shows an error message.")])]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: View many case logs of a specific student")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User searches for specific student.")])]),_v(" "),_c('li',[_c('p',[_v("CogniCare shows a list of students that meet the criteria.")])]),_v(" "),_c('li',[_c('p',[_v("User requests to see all appointments' case log at the given the student index.")])]),_v(" "),_c('li',[_c('p',[_v("CogniCare shows a list of all appointments' case log that meet the criteria.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The query has missing parameters")]),_v(" "),_c('ul',[_c('li',[_v("1a1. CogniCare shows an error message.")])]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("2a. The list of students is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The query has missing parameters")]),_v(" "),_c('ul',[_c('li',[_v("3a1. CogniCare shows an error message.")])]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("4a. The list of appointments is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Edit one case log of an appointment of a specific student")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User searches for specific student.")])]),_v(" "),_c('li',[_c('p',[_v("CogniCare shows a list of students that meet the criteria.")])]),_v(" "),_c('li',[_c('p',[_v("User requests to see all appointments' case log at the given the student index.")])]),_v(" "),_c('li',[_c('p',[_v("CogniCare shows a list of all appointments' case log that meet the criteria.")])]),_v(" "),_c('li',[_c('p',[_v("User requests to edit the case log of the appointment at the given student and appointment.")])]),_v(" "),_c('li',[_c('p',[_v("CogniCare edits the case log for the specified appointment and student.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The query has missing parameters")]),_v(" "),_c('ul',[_c('li',[_v("1a1. CogniCare shows an error message.")])]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("2a. The list of students is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The query has missing parameters")]),_v(" "),_c('ul',[_c('li',[_v("3a1. CogniCare shows an error message.")])]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("4a. The list of appointments is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("5a. The query has missing/out of bound parameters")]),_v(" "),_c('ul',[_c('li',[_v("5a1. CogniCare shows an error message.")])]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Create one case log of a appointment of a specific student")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User searches for specific student.")])]),_v(" "),_c('li',[_c('p',[_v("CogniCare shows a list of students that meet the criteria.")])]),_v(" "),_c('li',[_c('p',[_v("User requests to list all appointments at the given the student index.")])]),_v(" "),_c('li',[_c('p',[_v("CogniCare shows a list of appointments that meet the criteria.")])]),_v(" "),_c('li',[_c('p',[_v("User requests to create the case log of the appointment at the given student and appointment.")])]),_v(" "),_c('li',[_c('p',[_v("CogniCare create the case log for the specified appointment and student.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ul',[_c('li',[_c('p',[_v("*a. User presses the Down arrow key when there is no next command")]),_v(" "),_c('ul',[_c('li',[_v("*b1. An empty string is returned")])]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.4.0")]),_v(", generated on Thu, 4 Apr 2024, 18:14:46 GMT+8]")])])])}
}];
