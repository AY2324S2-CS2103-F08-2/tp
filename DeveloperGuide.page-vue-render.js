...
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The query has missing parameters")]),_v(" "),_c('ul',[_c('li',[_v("1a1. CogniCare shows an error message that the index is invalid.")])]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("2a. User does not want to delete.")]),_v(" "),_c('ul',[_c('li',[_v("1a1. CogniCare shows an error message that the user cancelled the delete operation.")])]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.3.0")]),_v(", generated on Tue, 5 Mar 2024, 20:42:25 GMT+8]")])])])}
}];
